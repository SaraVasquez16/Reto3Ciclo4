...
public class OrderController {
    ...
    //Métodos del reto 4
    //Reto 4:Ordenes de pedido asociadas a los salesMan
    ...
    public List<Order> findBySalesManByState(@PathVariable("state") String state, @PathVariable("id") Integer id){
        return orderService.findBySalesManByState(state, id);
    }
